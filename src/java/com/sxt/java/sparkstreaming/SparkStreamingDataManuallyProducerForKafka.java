...
public class SparkStreamingDataManuallyProducerForKafka extends Thread{
    ...
    public SparkStreamingDataManuallyProducerForKafka(String topic){
        ...
        conf.put("metadata.broker.list","node1:9092,node2:9092,node3:9092");
...
//			producerForKafka.send(new KeyedMessage<Integer, String>(topic,111,userLog));
			//每两条数据暂停2秒
			if(0 == counter%2){
				counter = 0;
				try {
    ...
    public static void main( String[] args ){
    	...
    	new SparkStreamingDataManuallyProducerForKafka("t1202").start();
